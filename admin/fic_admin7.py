...
def sendToFile():
    try:
        if os.path.getsize('./admin/readadmin/fileAdmin7.txt'):
            print("File 'fileAdmin7.txt' exist !")
    except FileNotFoundError as infofile :
        print("File : 'fileAdmin7' does not exist !", infofile)
        print("File : 'fileAdmin7' created !")
    finally:
        with open('./admin/readadmin/fileAdmin7.txt', 'a+') as file:
            file.write(str("Date : "))
...
def readToFile():
	subprocess.call('./admin/readadmin/readadminfile7.py')
