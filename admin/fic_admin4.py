...
def sendToFile():
    try:
        if os.path.getsize('./admin/readadmin/fileAdmin4.txt'):
            print("File 'fileAdmin4.txt' exist !")
    except FileNotFoundError as infofile :
        print("File : 'fileAdmin4' does not exist !", infofile)
        print("File : 'fileAdmin4' created !")
    finally:
        with open('./admin/readadmin/fileAdmin4.txt', 'a+') as file:
            file.write(str("Date : "))
...
def readToFile():
	subprocess.call('./admin/readadmin/readadminfile4.py')
