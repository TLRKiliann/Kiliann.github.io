...
def sendToFile():
    try:
        if os.path.getsize('./admin/readadmin/fileAdmin5.txt'):
            print("File 'fileAdmin5.txt' exist !")
    except FileNotFoundError as infofile :
        print("File : 'fileAdmin5' does not exist !", infofile)
        print("File : 'fileAdmin5' created !")
    finally:
        with open('./admin/readadmin/fileAdmin5.txt', 'a+') as file:
            file.write(str("Date : "))
...
def readToFile():
	subprocess.call('./admin/readadmin/readadminfile5.py')
