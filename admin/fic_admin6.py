...
def sendToFile():
    try:
        if os.path.getsize('./admin/readadmin/fileAdmin6.txt'):
            print("File 'fileAdmin6.txt' exist !")
    except FileNotFoundError as infofile :
        print("File : 'fileAdmin6' does not exist !", infofile)
        print("File : 'fileAdmin6' created !")
    finally:
        with open('./admin/readadmin/fileAdmin6.txt', 'a+') as file:
            file.write(str("Date : "))
...
def readToFile():
	subprocess.call('./admin/readadmin/readadminfile6.py')
