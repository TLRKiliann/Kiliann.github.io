...
def sendToFile():
    try:
        if os.path.getsize('./admin/readadmin/fileAdmin3.txt'):
            print("File 'fileAdmin3.txt' exist !")
    except FileNotFoundError as infofile :
        print("File : 'fileAdmin3' does not exist !", infofile)
        print("File : 'fileAdmin3' created !")
    finally:
        with open('./admin/readadmin/fileAdmin3.txt', 'a+') as file:
            file.write(str("Date : "))
...
def readToFile():
	subprocess.call('./admin/readadmin/readadminfile3.py')
