...
try:
    importationFile1('./calBmi/bmi4.txt',
        encodage="Utf-8")
except FileNotFoundError file1:
    print("bmi4.txt not exist", file1)

try:
    importationFile2('./param/Main4.txt',
        encodage="Utf-8")
except FileNotFoundError file2:
    print("Main4.txt not exist", file2)

try:
    importationFile3('./vmed/doc_vmed4/resultvmed.txt',
        encodage="Utf-8")
except FileNotFoundError file3:
    print("resultvmed.txt not exist", file3)

try:
    importationFile4('./14besoins/doc_suivi4/main_14b.txt',
        encodage="Utf-8")
