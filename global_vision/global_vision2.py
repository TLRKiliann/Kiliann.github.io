...
try:
    importationFile1('./calBmi/bmi2.txt',
        encodage="Utf-8")
except FileNotFoundError as file1:
    print("bmi2.txt not exist", file1)

try:
    importationFile2('./param/Main2.txt',
        encodage="Utf-8")
except FileNotFoundError as file2:
    print("Main2.txt not exist", file2)

try:
    importationFile3('./vmed/doc_vmed2/resultvmed.txt',
        encodage="Utf-8")
except FileNotFoundError as file3:
    print("resultvmed.txt not exist", file3)

try:
    importationFile4('./14besoins/doc_suivi2/main_14b.txt',
        encodage="Utf-8")
