...
try:
    importationFile1('./calBmi/bmi6.txt',
        encodage="Utf-8")
except FileNotFoundError file1:
    print("bmi6.txt not exist", file1)

try:
    importationFile2('./param/Main6.txt',
        encodage="Utf-8")
except FileNotFoundError file2:
    print("Main6.txt not exist", file2)

try:
    importationFile3('./vmed/doc_vmed6/resultvmed.txt',
        encodage="Utf-8")
except FileNotFoundError file3:
    print("resultvmed.txt not exist", file3)

try:
    importationFile4('./14besoins/doc_suivi6/main_14b.txt',
        encodage="Utf-8")
