...
def appelTens():
    ...
    try:
        if os.path.getsize('./param/aspifile5/tensor.json'):
            subprocess.call('./param/aspifile5/aspidata.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nTension: " + textTa.get())
...
def appelPuls():
    ...
    try:
        if os.path.getsize('./param/aspifile5/puls.json'):
            subprocess.call('./param/aspifile5/aspipuls.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelSat():
    ...
    try:
        if os.path.getsize('./param/aspifile5/sat.json'):
            subprocess.call('./param/aspifile5/aspisat.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nSaO2: " + textSa.get())
...
def appelFreq():
    ...
    try:
        if os.path.getsize('./param/aspifile5/freq.json'):
            subprocess.call('./param/aspifile5/aspifreq.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelTemp():
    ...
    try:
        if os.path.getsize('./param/aspifile5/temp.json'):
            subprocess.call('./param/aspifile5/aspitemp.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelGly():
    ...
    try:
        if os.path.getsize('./param/aspifile5/gly.json'):
            subprocess.call('./param/aspifile5/aspigly.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelDlr():
    ...
    try:
        if os.path.getsize('./param/aspifile5/dlr.json'):
            subprocess.call('./param/aspifile5/aspidlr.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nDouleurs: " + textDlrs.get())
...
def delMain():
    """
    To earase Main5.json
    """
    Main_MsgBox = messagebox.askquestion("Confirm","Are you sure ?\n"
        "It will delete Main5.json with all data !!!")
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/Main5.json'):
                os.remove('./param/Main5.json')
                label['text'] = "File Main5.json has been deleted !"
                print("+ File Main5.json has been deleted !")
...
name_text.set("Nom du patient 5")
...
buttonDel = Button(gui)
buttonDel.config(text='Supprimer Main5', width=15, bg='coral', fg='yellow',
