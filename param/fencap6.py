...
def appelTens():
    ...
    try:
        if os.path.getsize('./param/aspifile6/tensor.json'):
            subprocess.call('./param/aspifile6/aspidata.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nTension: " + textTa.get())
...
def appelPuls():
    ...
    try:
        if os.path.getsize('./param/aspifile6/puls.json'):
            subprocess.call('./param/aspifile6/aspipuls.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelSat():
    ...
    try:
        if os.path.getsize('./param/aspifile6/sat.json'):
            subprocess.call('./param/aspifile6/aspisat.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nSaO2: " + textSa.get())
...
def appelFreq():
    ...
    try:
        if os.path.getsize('./param/aspifile6/freq.json'):
            subprocess.call('./param/aspifile6/aspifreq.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelTemp():
    ...
    try:
        if os.path.getsize('./param/aspifile6/temp.json'):
            subprocess.call('./param/aspifile6/aspitemp.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelGly():
    ...
    try:
        if os.path.getsize('./param/aspifile6/gly.json'):
            subprocess.call('./param/aspifile6/aspigly.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelDlr():
    ...
    try:
        if os.path.getsize('./param/aspifile6/dlr.json'):
            subprocess.call('./param/aspifile6/aspidlr.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nDouleurs: " + textDlrs.get())
...
def delMain():
    """
    To earase Main6.json
    """
    Main_MsgBox = messagebox.askquestion("Confirm","Are you sure ?\n"
        "It will delete Main6.json with all data !!!")
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/Main6.json'):
                os.remove('./param/Main6.json')
                label['text'] = "File Main6.json has been deleted !"
                print("+ File Main6.json has been deleted !")
...
name_text.set("Nom du patient 6")
...
buttonDel = Button(gui)
buttonDel.config(text='Supprimer Main6', width=15, bg='coral', fg='yellow',
