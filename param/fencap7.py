...
def appelTens():
    ...
    try:
        if os.path.getsize('./param/aspifile7/tensor.json'):
            subprocess.call('./param/aspifile7/aspidata.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nTension: " + textTa.get())
...
def appelPuls():
    ...
    try:
        if os.path.getsize('./param/aspifile7/puls.json'):
            subprocess.call('./param/aspifile7/aspipuls.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelSat():
    ...
    try:
        if os.path.getsize('./param/aspifile7/sat.json'):
            subprocess.call('./param/aspifile7/aspisat.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nSaO2: " + textSa.get())
...
def appelFreq():
    ...
    try:
        if os.path.getsize('./param/aspifile7/freq.json'):
            subprocess.call('./param/aspifile7/aspifreq.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelTemp():
    ...
    try:
        if os.path.getsize('./param/aspifile7/temp.json'):
            subprocess.call('./param/aspifile7/aspitemp.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelGly():
    ...
    try:
        if os.path.getsize('./param/aspifile7/gly.json'):
            subprocess.call('./param/aspifile7/aspigly.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelDlr():
    ...
    try:
        if os.path.getsize('./param/aspifile7/dlr.json'):
            subprocess.call('./param/aspifile7/aspidlr.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nDouleurs: " + textDlrs.get())
...
def delMain():
    """
    To earase Main7.json
    """
    Main_MsgBox = messagebox.askquestion("Confirm","Are you sure ?\n"
        "It will delete Main7.json with all data !!!")
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/Main7.json'):
                os.remove('./param/Main7.json')
                label['text'] = "File Main7.json has been deleted !"
                print("+ File Main7.json has been deleted !")
...
name_text.set("Nom du patient 7")
...
buttonDel = Button(gui)
buttonDel.config(text='Supprimer Main7', width=15, bg='coral', fg='yellow',
