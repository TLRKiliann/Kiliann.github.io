...
def appelTens():
    ...
    try:
        if os.path.getsize('./param/aspifile3/tensor.json'):
            subprocess.call('./param/aspifile3/aspidata.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nTension: " + textTa.get())
...
def appelPuls():
    ...
    try:
        if os.path.getsize('./param/aspifile3/puls.json'):
            subprocess.call('./param/aspifile3/aspipuls.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelSat():
    ...
    try:
        if os.path.getsize('./param/aspifile3/sat.json'):
            subprocess.call('./param/aspifile3/aspisat.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nSaO2: " + textSa.get())
...
def appelFreq():
    ...
    try:
        if os.path.getsize('./param/aspifile3/freq.json'):
            subprocess.call('./param/aspifile3/aspifreq.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelTemp():
    ...
    try:
        if os.path.getsize('./param/aspifile3/temp.json'):
            subprocess.call('./param/aspifile3/aspitemp.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelGly():
    ...
    try:
        if os.path.getsize('./param/aspifile3/gly.json'):
            subprocess.call('./param/aspifile3/aspigly.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelDlr():
    ...
    try:
        if os.path.getsize('./param/aspifile3/dlr.json'):
            subprocess.call('./param/aspifile3/aspidlr.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nDouleurs: " + textDlrs.get())
...
def delMain():
    """
    To earase Main3.json
    """
    Main_MsgBox = messagebox.askquestion("Confirm","Are you sure ?\n"
        "It will delete Main3.json with all data !!!")
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/Main3.json'):
                os.remove('./param/Main3.json')
                label['text'] = "File Main3.json has been deleted !"
                print("+ File Main3.json has been deleted !")
...
name_text.set("Nom du patient 3")
...
buttonDel = Button(gui)
buttonDel.config(text='Supprimer Main3', width=15, bg='coral', fg='yellow',
