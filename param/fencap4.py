...
def appelTens():
    ...
    try:
        if os.path.getsize('./param/aspifile4/tensor.json'):
            subprocess.call('./param/aspifile4/aspidata.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nTension: " + textTa.get())
...
def appelPuls():
    ...
    try:
        if os.path.getsize('./param/aspifile4/puls.json'):
            subprocess.call('./param/aspifile4/aspipuls.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelSat():
    ...
    try:
        if os.path.getsize('./param/aspifile4/sat.json'):
            subprocess.call('./param/aspifile4/aspisat.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nSaO2: " + textSa.get())
...
def appelFreq():
    ...
    try:
        if os.path.getsize('./param/aspifile4/freq.json'):
            subprocess.call('./param/aspifile4/aspifreq.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelTemp():
    ...
    try:
        if os.path.getsize('./param/aspifile4/temp.json'):
            subprocess.call('./param/aspifile4/aspitemp.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelGly():
    ...
    try:
        if os.path.getsize('./param/aspifile4/gly.json'):
            subprocess.call('./param/aspifile4/aspigly.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
...
def appelDlr():
    ...
    try:
        if os.path.getsize('./param/aspifile4/dlr.json'):
            subprocess.call('./param/aspifile4/aspidlr.py', shell=True)
            label['text'] = ("Date: " + textDate.get() +" -- "+ "Nom: " + textName.get() +
                "\nDouleurs: " + textDlrs.get())
...
def delMain():
    """
    To earase Main4.json
    """
    Main_MsgBox = messagebox.askquestion("Confirm","Are you sure ?\n"
        "It will delete Main4.json with all data !!!")
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/Main4.json'):
                os.remove('./param/Main4.json')
                label['text'] = "File Main4.json has been deleted !"
                print("+ File Main4.json has been deleted !")
...
name_text.set("Nom du patient 4")
...
buttonDel = Button(gui)
buttonDel.config(text='Supprimer Main4', width=15, bg='coral', fg='yellow',
