...
def searchExpress():
    ...
    """
    mot = regexpi_var.get()
    with open('fixed_rdv.txt', 'r') as textfile1:
    ...
    with open('modifrdv.txt', 'r') as textfile2:
...
def save_input():
    ...
    with open('fixed_rdv.txt', 'r') as fr:
        with open('modifrdv.txt', 'a+') as fw1:
            with open('fixed_rdv.txt', 'a+') as fw2:
...
def modifList():
    ...
    """
    subprocess.call('./read_filemodif.py')
