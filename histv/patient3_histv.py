...
class Application(Frame):
    ...
    def lienDirect(self):
        ...
        """
        try:
            if os.path.getsize('./histv/doc_histv3/Hvie_patient1.txt'):
            ...
            with open('./histv/doc_histv3/Hvie_patient1.txt', 'w') as file:
                file.write(".")
            self.confRec()
    ...
    def lectureFic(self):
        ...
        try:
            if os.path.getsize('./histv/doc_histv3/Hvie_patient1.txt'):
                ...
                subprocess.call('./histv/doc_histv3/story_read.py')
