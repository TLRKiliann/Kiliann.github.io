...
class Application(Frame):
    def __init__(self, boss=None):
        ...
        self.can.create_text(20, 150, anchor=NW, text="Suivi: Patient 3",
    ...
    def suivia(self):
        ...
        filepath=filedialog.askopenfilename(filetypes=[('./suivi/suivi_doc/suivi_patient_3/sui_01.01.19_AE', '.txt')])
        fichier=open('./suivi/suivi_doc/suivi_patient_3/sui_01.01.19_AE.txt', 'r')
    ...
    def entrerEcrit1(self):
        fichier=open('./suivi/suivi_doc/suivi_patient_3/sui_01.01.19_AE.txt', 'a+')
        fichier.write("\n" + self.new_totext.get())
        fichier.close()
    ...
    def suivia2(self):
        ...
        filepath=filedialog.askopenfilename(filetypes=[('./suivi/suivi_doc/suivi_patient_3/sui_07.01.19_AE', '.txt')])
        fichier=open('./suivi/suivi_doc/suivi_patient_3/sui_07.01.19_AE.txt', 'r')
        content=fichier.read()
        fichier.close()
    ...
    def entrerEcrit2(self):
        fichier=open('./suivi/suivi_doc/suivi_patient_3/sui_07.01.19_AE.txt', 'a+')
        fichier.write("\n" + self.new_text.get())
        fichier.close()
    ...
    def suivia3(self):
        ...
        filepath=filedialog.askopenfilename(filetypes=[('./suivi/suivi_doc/suivi_patient_3/sui_16.01.19_AE', '.txt')])
        fichier=open('./suivi/suivi_doc/suivi_patient_3/sui_16.01.19_AE.txt', 'r')
        content=fichier.read()
        fichier.close()
        self.label=Label(self.label, justify=LEFT, font=('Times', 12), bg='gray22', fg='cyan', 
            text=content).pack(padx=10, pady=10)
    ...
    def entrerEcrit3(self):
        fichier=open('./suivi/suivi_doc/suivi_patient_3/sui_16.01.19_AE.txt', 'a+')
        fichier.write("\n" + self.new_text2.get())
        fichier.close()
    ...
    def suivia4(self):
        ...
        filepath=filedialog.askopenfilename(filetypes=[('./suivi/suivi_doc/suivi_patient_3/sui_20.01.19_AE', '.txt')])
        fichier=open('./suivi/suivi_doc/suivi_patient_3/sui_20.01.19_AE.txt', 'r')
        content=fichier.read()
        fichier.close()
        self.label=Label(self.label, justify=LEFT, font=('Times', 12), bg='gray22', fg='cyan', 
            text=content).pack(padx=10, pady=10)
    ...
    def entrerEcrit4(self):
        fichier=open('./suivi/suivi_doc/suivi_patient_3/sui_20.01.19_AE.txt', 'a+')
        fichier.write("\n" + self.new_text3.get())
        fichier.close()
