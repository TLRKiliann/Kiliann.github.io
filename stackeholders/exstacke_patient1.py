...
class Application(Frame):
    ...
    def linkNeeds(self):
        try:
            if os.path.getsize('./14besoins/doc_suivi/patient1_14b.txt'):
                print("+ File '14Needs' exist (add)!")
                subprocess.call('./14besoins/doc_suivi/patient1_write.py')
        except FileNotFoundError as outmsg:
            print("+ Sorry, file '14Needs' not exist !", outmsg)
            print("+ File 14Needs created !")
            self.confRec()
    ...
    def readFileNeeds(self):
        try:
            if os.path.getsize('./14besoins/doc_suivi/patient1_14b.txt'):
                print("+ File '14Needs' exist (read)!")
                subprocess.call('./14besoins/doc_suivi/patient1_read.py')
        except FileNotFoundError as outcom:
            print("+ Sorry, file '14Needs' not exist !", outcom)
            self.confRec()
