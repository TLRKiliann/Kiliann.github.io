...
def saveData():
    ...
    it before.
    """
    with open('./auxsrc/doc_auxsrc2/auxsrcfile2.txt', 'a+') as filerecord:
...
def readerFile():
    ...
    """
    with open('./auxsrc/doc_auxsrc2/auxsrcfile2.txt', 'r') as filereader:
...
importationFile('./auxsrc/doc_auxsrc2/auxsrcfile2.txt',
    encodage="Utf-8")
