...
def saveData():
    ...
    it before.
    """
    with open('./auxsrc/doc_auxsrc7/auxsrcfile7.txt', 'a+') as filerecord:
...
def readerFile():
    ...
    """
    with open('./auxsrc/doc_auxsrc7/auxsrcfile7.txt', 'r') as filereader:
...
importationFile('./auxsrc/doc_auxsrc7/auxsrcfile7.txt',
    encodage="Utf-8")
