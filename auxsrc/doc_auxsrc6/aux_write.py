...
def saveData():
    ...
    it before.
    """
    with open('./auxsrc/doc_auxsrc6/auxsrcfile6.txt', 'a+') as filerecord:
...
def readerFile():
    ...
    """
    with open('./auxsrc/doc_auxsrc6/auxsrcfile6.txt', 'r') as filereader:
...
importationFile('./auxsrc/doc_auxsrc6/auxsrcfile6.txt',
    encodage="Utf-8")
