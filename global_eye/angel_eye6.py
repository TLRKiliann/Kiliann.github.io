...
try:
    importationFile1('./diag/doc_diag6/diagrecap.txt',
        encodage="Utf-8")
...
try:
    ...
    print("auxsrcfile6.txt not exist", file3)

try:
    importationFile4('./histv/doc_histv6/Hvie_patient6.txt',
        encodage="Utf-8")
except FileNotFoundError as file4:
    print("Hvie_patient6.txt not exist", file4)
