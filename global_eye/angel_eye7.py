...
try:
    importationFile1('./diag/doc_diag7/diagrecap.txt',
        encodage="Utf-8")
except FileNotFoundError as file1:
    print("diagrecap.txt not exist", file1)

try:
    importationFile2('./patient_agenda/events7/doc_events/fix_agenda/fixed_rdv.txt',
        encodage="Utf-8")
