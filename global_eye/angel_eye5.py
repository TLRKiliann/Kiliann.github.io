...
try:
    importationFile3('./auxsrc/doc_auxsrc5/auxsrcfile5.txt',
        encodage="Utf-8")
except FileNotFoundError as file3:
    print("auxsrcfile5.txt not exist", file3)

try:
    importationFile4('./histv/doc_histv5/Hvie_patient5.txt',
        encodage="Utf-8")
except FileNotFoundError as file4:
    print("Hvie_patient5.txt not exist", file4)
