...
try:
    importationFile1('./diag/doc_diag3/diagrecap.txt',
        encodage="Utf-8")
except FileNotFoundError as file1:
    print("diagrecap.txt not exist", file1)

try:
    importationFile2('./patient_agenda/events3/doc_events/fix_agenda/fixed_rdv.txt',
        encodage="Utf-8")
except FileNotFoundError as file2:
    print("fixed_rdv.txt not exist", file2)

try:
    importationFile3('./auxsrc/doc_auxsrc3/auxsrcfile3.txt',
        encodage="Utf-8")
except FileNotFoundError as file3:
    print("auxsrcfile3.txt not exist", file3)

try:
    importationFile4('./histv/doc_histv3/Hvie_patient3.txt',
        encodage="Utf-8")
except FileNotFoundError as file4:
    print("Hvie_patient3.txt not exist", file4)
