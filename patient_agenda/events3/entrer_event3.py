...
file=open('./patient_agenda/events3/patient_3_calendar.txt','rb')
data=load(file)
file.close()
...
try:
    if os.path.getsize('./patient_agenda/events3/doc_events/patient3_rdv.json'):
        print("+ File 'patient3_rdv.json' exist !")   
        with open('./patient_agenda/events3/doc_events/patient3_rdv.json', 'w') as datafile:
