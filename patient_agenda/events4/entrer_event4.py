...
file=open('./patient_agenda/events4/patient_4_calendar.txt','rb')
data=load(file)
file.close()
...
try:
    if os.path.getsize('./patient_agenda/events4/doc_events/patient4_rdv.json'):
        print("+ File 'patient4_rdv.json' exist !")   
        with open('./patient_agenda/events4/doc_events/patient4_rdv.json', 'w') as datafile:
